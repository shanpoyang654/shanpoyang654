...
| **[PhysPO: Physics-Aware Local Preference Optimization for Physically Consistent Video Generation](https://shanpoyang654.github.io/PhysPO/page.html)** | ![ECCV2026](https://img.shields.io/badge/ECCV-2026-blue) | Construct CounterPhy (30K+) physics-inconsistent preference pairs and propose a physics-aware DPO framework with FFT-based physical region masks for localized preference optimization. Improves physical commonsense (PC) and semantic adherence (SA) on VideoPhy1/2, outperforming CogVideoX, Wan2.1, Sora2, and PhyT2V.. | `PyTorch` `Wan` `MMDiT` `ControlNet` |
